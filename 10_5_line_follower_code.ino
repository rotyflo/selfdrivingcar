...
const int S_pin = ___; //proportional control
const int P_pin = ___; //proportional control
const int I_pin = ___; //integral control
const int D_pin = ___; //derivative control
...
const float speed       = ___;
const float proportion  = ___;
const float integral    = ___;
const float derivative  = ___;
